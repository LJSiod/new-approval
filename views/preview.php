    ...
    <div class="br-section-wrapper mt-3">
          ...
          <form method="post" action="../actions/edit.php">
            ...
            <div class="form-group col-sm">
                ...
                <input type="text" name="name" id="names" required="" class="form-control form-control-sm" value="<?= $row['Borrower'] ?>">
            </div>

            <div class="form-group col-sm">
                 <strong><label class="text-muted">Borrower's Address</label></strong>
                <input type="text" name="address" id="addresss" required=""  class="form-control form-control-sm" value="<?= $row['Address'] ?>">
            </div>
            <div class="form-group col-sm">
              <strong><label class="text-muted">Source of Fund:</label></strong>
              <select class="form-control form-control-sm" id="asourceoffunds" name="sourceoffund" data-placeholder="Choose source of fund" tabindex="2" aria-hidden="true">
            ...
            <div class="form-group col-sm">
                ...
                <input type="text" name="purposeofloan" id="purposeofloans" required=""  class="form-control form-control-sm" value="<?= $row['LoanPurpose'] ?>">
            </div>

            <div class="form-group col-sm">
                 <strong><label class="text-muted">Requirements Passed</label></strong>
                <input type="text" name="requirement" id="requirements" required=""  class="form-control form-control-sm" value="<?= $row['RequirementsPassed'] ?>">
            </div>
            </div>
            <div class="form-row">
            <div class="form-group col-sm">
                 <strong><label class="text-muted">Name of Credit Investigator</label></strong>
                <input type="text" name="ci" id="cis" required=""  class="form-control form-control-sm" value="<?= $row['NameofCI'] ?>">
            </div>
            <div class="form-group col-sm">
                 <strong><label class="text-muted">Estimated Monthly Income</label></strong>
                <input type="number" name="monthlyincome" id="monthlyincomes" required=""  class="form-control form-control-sm" value="<?= $row['MonthlyIncome'] ?>">
            </div>
            <div class="form-group col-sm">
                 <strong><label class="text-muted">Previous Loan Amount</label></strong>
                <input type="number" name="prevs" id="prevs" required=""  class="form-control form-control-sm" value="<?= $row['PreviousLoanAmount'] ?>">
            </div>

            <div class="form-group col-sm">
                 <strong><label class="text-muted">Proposed Loan Amount</label></strong>
                <input type="number" name="proposed" id="proposeds" required=""  class="form-control form-control-sm" value="<?= $row['ProposedLoanAmount'] ?>">
            </div>

            <div class="form-group col-sm">
                 <strong><label class="text-muted">Approved Loan Amount</label></strong>
                <input type="number" name="approved" id="approveds" required=""  class="form-control form-control-sm" value="<?= $row['ApprovedLoanAmount'] ?>">
            </div>
            </div>

            <div class="form-row" style="height: 40vh;">
              <div class="form-group col-sm">
              ...
              <div class="form-row" name="ledgers" id="ledgers">
              ...
              <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Account Information</h6>
              <div class="form-row">
                <div class="form-group col-sm" id="nocycle">
                  <strong><label class="text-muted" for="cycle">No. of Cycle</label></strong>
                  <input type="number" name="cycle" id="cycles" required="" class="form-control form-control-sm" value="<?= $row['Cycle']; ?>">
                </div>
                <div class="form-group col-sm" id="paidss">
                ...
                <div class="form-group col-sm" id="balancess">
                  <strong><label class="text-muted" for="balance">Remaining Balance</label></strong>
                  <input type="number" name="balance" id="balances" class="form-control form-control-sm" value="<?= $row['Balance']; ?>">
                </div>

                <div class="form-group col-sm" id="accountstatuss">
                  <strong><label class="text-muted" for="accountstatus">Account Status:</label></strong>
                  <select class="form-control form-control-sm" id="accstats" name="accountstatus" tabindex="13" aria-hidden="true">
                    <option value=""></option>
              ...
              <div class="form-row">
                <div class="form-group col-sm">
                  ...
                  <select class="form-control form-control-sm" name="type" id="acctype" data-placeholder="Choose account type" tabindex="3" aria-hidden="true">
                ...
                <div class="form-group col-sm">
                  ...
                  <select class="form-control form-control-sm" id="allocations" name="allocation" data-placeholder="Choose account allocation" tabindex="7" aria-hidden="true">
                    <option>Neo</option>
                    <option>Gen</option>
                  </select>
                </div>
                ...
                <div class="form-group col-sm">
                  ...
                  <select class="form-control form-control-sm" id="statuss" name="status" tabindex="13" aria-hidden="true">
                ...
                <div class="form-group col-sm">
                  <strong><label class="text-muted">Borrower Status</label></strong>
                  <input type="text" id="statuss" name="status" class="form-control form-control-sm" value="<?= $row['Status']; ?>" readonly></input>
                </div>
                <?php } ?>
              
              <div class="form-group col-sm">
                <strong><label class="text-muted">Remarks</label></strong>
                <input type="text" id="remarkss" name="remark" class="form-control form-control-sm" value="<?= $row['Remarks']; ?>" <?php if ($branchid != 1) { echo 'readonly'; } ?>></input>
              </div>
            </div>
            <div class="form-group col-sm ml-auto d-flex justify-content-end">
              <button type="submit" name="save" class="btn btn-sm btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Save Changes</button>
              <button type="button" class="btn btn-sm btn-secondary ml-2 tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" onclick="window.history.back()">Close</button>
            </div>
          </form>      
        </div>
