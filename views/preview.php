    ...
    <form method="post" action="../actions/edit.php">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-sm">
          ...
          <select class="form-control form-control-sm" id="asourceoffunds" name="sourceoffund"
            data-placeholder="Choose source of fund" tabindex="2" aria-hidden="true">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-sm" id="accountstatuss">
          ...
          <select class="form-control form-control-sm" id="accstats" name="accountstatus" tabindex="13"
            aria-hidden="true">
            <option value=""></option>
      ...
      <div class="form-row">
        <div class="form-group col-sm">
          ...
          <select class="form-control form-control-sm" name="type" id="acctype" data-placeholder="Choose account type"
        ...
        <div class="form-group col-sm">
          ...
          <select class="form-control form-control-sm" id="allocations" name="allocation"
            data-placeholder="Choose account allocation" tabindex="7" aria-hidden="true">
            <option>Neo</option>
            <option>Gen</option>
          </select>
        </div>
        ...
        <?php } else { ?>
          <div class="form-group col-sm">
            ...
            <input type="text" id="statuss" name="status" class="form-control form-control-sm"
              value="<?= $row['Status']; ?>" readonly></input>
          </div>
        <?php } ?>
      ...
      <div class="form-group col-sm ml-auto d-flex justify-content-end">
        ...
        <button type="button" class="btn btn-sm btn-secondary ml-2 tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"
