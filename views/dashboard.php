            ...
            <div class="br-section-wrapper mt-3">
                ...
                <div class="d-flex">
                    <p class="mr-auto text-muted">
                        <i class="fa fa-square" style="color: #98FB98"></i><span class="small font-weight-bold">
                            :Approved</span>
                        <i class="fa fa-square ml-3" style="color: #FFCCCB"></i><span class="small font-weight-bold">
                            :Disapproved</span>
                        <i class="fa fa-square ml-3" style="color: #FFEEBA"></i><span class="small font-weight-bold">
                            :Pending</span>
                    </p>
                    <?php if ($branchid == 1) { ?>
